...
int monthly_rate(double hourly_rate, double discount) {
    ...
    double final_monthly_rate = apply_discount(before_discount, discount);
    return final_monthly_rate;
}
...
int days_in_budget(int budget, double hourly_rate, double discount) {
    ...
    double before_discount = monthly_rate(hourly_rate, discount);
    int final_work_days = budget/before_discount;
    return final_work_days;
}
